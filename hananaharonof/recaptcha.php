...
<body>
    ...
    <div class="wrapper">
        <header class="header">
            <div class="head-bg" style="background-image: url('img/backgrounds/siena.jpg')"></div>
        ...
        <div class="content">
			...
			<?php require_once __DIR__ . '/php/recaptcha/autoload.php';				
				$siteKey = '6LermiUTAAAAAAEzuQ_QT43dl6p9vToHpqIOep-B'; // visit https://www.google.com/recaptcha/admin to generate keys
				$secret = '6LermiUTAAAAAFiQ80GGD0LkIG1wA4y5fOn3kTwm';
	    ...
	    <footer class="footer">
	        <div class="footer-social">
	            <ul class="social">
	                <li><a class="ripple-centered" href="https://www.facebook.com/people/Hanan-Aharonof/592051957" target="_blank"><i class="rsicon rsicon-facebook"></i></a></li>
	                <li><a class="ripple-centered" href="https://www.linkedin.com/in/hananaharonof" target="_blank"><i class="rsicon rsicon-linkedin"></i></a></li>
	            </ul>
	        </div>
	    </footer>
    </div><!-- .wrapper -->
